...
```bash
 git clone https://github.com/localhosts-A/small-package
```
2. 或者添加下面代码到feeds.conf.default文件

```bash
 src-git small8 https://github.com/localhosts-A/small-package
```
3. lede/下运行 或者openwrt/下运行

```bash
git clone https://github.com/localhosts-A/small-package package/small-package
```
